...
<p> <i><sup>A lot my repo's are private or tied to an organization, if you are curious about the inner workings of my repositories, contact me via Github</sup></i> </p>



<h2> 🌟 My Tech Journey </h2>

<img align="right" src="https://raw.githubusercontent.com/MK732/MK732/main/gilfoyle.gif" alt="Gilfoyle GIF" width="400" height="400" style="opacity: 0.9; margin-left: 40px; ">
<br>
...
<sup>A lot of my projects are tied to organizations and private repo's* </sup></li>
  ...
  <li style="margin-bottom: 15px;">💡 Available for collaboration on anything tech, product or business —feel free to reach out anytime!</li>
  <li style="margin-bottom: 15px;">⚽ Fun Fact: I’ve played soccer my whole life, and one of my favorite teams is Napoli!</li>
</ul>
...
<div align="center">
  ...
  <h2 style="font-size: 36px;">My Dev Arsenal</h2>
  
  [![My Skills](https://skillicons.dev/icons?i=fastapi,py,postgres,cs,dotnet,cpp,ts,aws,gcp,azure,docker,git,linux,mongodb,nextjs,supabase,nodejs,go,postman,powershell,discord,tailwind)]()
</div>
